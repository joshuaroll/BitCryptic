...
// Scene 5 (choice step): Stone door with handles and chalk text "TIFL OT NEPO"
...
<!-- Indistinct shapes deeper in the gloom (silhouettes only, nothing legible) -->
<rect x="170" y="195" width="40" height="25" rx="3" fill="#141c24" opacity="0.9"/>
<rect x="168" y="195" width="44" height="5" rx="2" fill="#1a232c" opacity="0.9"/>
<rect x="290" y="198" width="35" height="22" rx="3" fill="#141c24" opacity="0.9"/>
<rect x="288" y="192" width="39" height="8" rx="2" fill="#1a232c" opacity="0.9" transform="rotate(-8,307,196)"/>
